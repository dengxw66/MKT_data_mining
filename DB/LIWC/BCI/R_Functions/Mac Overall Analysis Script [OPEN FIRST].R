...
# in mac, use the following script
...
# Having rJava issues? Try these steps here https://zhiyzuo.github.io/installation-rJava/

library(rJava)
options(java.home="/Library/Java/JavaVirtualMachines/jdk1.8.0_60.jdk")
